...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    id: "fabricating",
    title: "Fabricating",
    body: "The Fabricator, in the Foundry program, crafts real components, ship systems, combat weapons, and combat drone pods from the refined materials the Refinery produces, using the blueprints you have unlocked at the Research Lab. Combat weapons and drone pods are craftable categories alongside components and ship systems: research a weapon or drone-pod blueprint, then fabricate it here just like any other system, and the finished weapon or pod lands in your spare pool, ready for the ship weapon and hangar-bay slots coming in a later update. Like the Refinery it runs as independent per-slot production lines, each with its own recipe, tier, and amount, and starting a craft reserves its materials up front so concurrent lines never fight over the same parts. Your crafting skill levels up as you fabricate. Any material's tooltip breaks its count into Allocated (held by running crafts), Free (available to start something new), and Total, and cancelling an unstarted line refunds its reserved materials to your Free pool.",
  },
  {
    id: "research",
    title: "Research",
    body: "The Research Lab, in the Foundry program, is where you unlock blueprints. Each research project takes time and credits and permanently unlocks something you can build, from component recipes to ship-system, combat-weapon, and combat drone-pod blueprints. Combat weapons and drone pods are researched here just like other ship systems: unlock a weapon or drone-pod blueprint, then craft it at the Fabricator. Projects are organized in tiers gated by the lab's own level, so upgrading the lab opens deeper research. Research is the front of the whole production chain: research a blueprint here, craft it at the Fabricator, then use the result to build ships or install their systems (installing crafted weapons and drone pods onto ships arrives in a later update).",
  },
  {
    id: "shipyard",
    title: "Shipyard",
